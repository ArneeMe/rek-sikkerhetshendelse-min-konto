  ...
  documents: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "text",
        required: true,
        placeholder: "F.eks. Ferieplan 2024-2025",
      },
      {
        name: "content",
        label: "Innhold",
        type: "textarea",
        required: true,
        placeholder: "Dokumentinnhold (støtter markdown-formatering)",
      },
      {
        name: "category",
        label: "Kategori",
        type: "select",
        required: true,
        options: ["policy", "procedure", "guide", "other"],
      },
    ],
  },
};
...
export function isValidTable(
  table: string
): table is keyof typeof TABLE_SCHEMAS {
